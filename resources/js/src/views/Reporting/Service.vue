  ...
  <div>
    ...
    <v-row v-if="data && !waiting">
     ...
     <v-col md="8" lg="8" sm="8">
        ...
        <v-card-title class="h-100 justify-content-center align-items-center">
          <h6 class="mx-auto" >
                      Veuillez choisir la période ou l'année, l'activité , le service et  le site  
                            puis valider .
          </h6>
        </v-card-title>
      </v-card>
...
export default {
  ...
  computed: {
   ...
   methods: {
     ...
     handlItems(){
       if(this.date.length ===0 || !this.site || !this.actviteId || !this.serviceId) {
     ...
     sendData(){
       ...
       var rangetosend = this.date
         ...
         store.dispatch('getReportingbySerice',data)
         .then(response=>{
